...
const AboutSetting = () => {
    ...
    const {data,refetch,isLoading,error} = useQuery("about",()=> fetch(`https://polar-beach-10719.herokuapp.com/about`).then(res=>res.json() ))
    const id = data?._id
    ...
    const onsubmit = data => {
      ...
      fetch(`https://polar-beach-10719.herokuapp.com/about/${id}`,{
        method:"PUT",
        headers:{
